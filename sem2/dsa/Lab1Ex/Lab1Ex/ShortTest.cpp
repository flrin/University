...
void my_test() {
	...
	//Extra
	std::pair<TValue, TValue> r = m.removeKey(10);
	std::pair<TValue, TValue> a1(NULL_TVALUE, NULL_TVALUE);
	std::pair<TValue, TValue> a2(10, 110);
	std::pair<TValue, TValue> a3(110, 10);
	std::pair<TValue, TValue> a4(5, NULL_TVALUE);
	assert(m.removeKey(99) == a1);
	assert(((r == a2) || (r == a3)));
	assert(m.removeKey(5) == a4);
	//
